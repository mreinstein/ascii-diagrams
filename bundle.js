(function (Display, index_js, bresenham) {
    'use strict';

    Display = Display && Display.hasOwnProperty('default') ? Display['default'] : Display;
    ...
    const asciiMachine = index_js.createMachine({
    ...
    const asciiService = index_js.interpret(asciiMachine).start();
